...
# kitty.class.generic_greeting # this will output because kitty.class is accessing the class of the instance method which is Cat. and because
# generic_greeting is being invoked on self which is the Cat class. This allows this to function properly
...
#4. Generic Greeting (Part 2)
  #Using the following code, add two methods: ::generic_greeting and #personal_greeting. The first method should be
  #a class method and print a greeting that's generic to the class. The second method should be an instance method and
